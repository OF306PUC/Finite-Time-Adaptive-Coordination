...
function createNodes(topologyConfig) {
    ...
    for (let i = 0; i < topologyConfig.length; i++) {
        ...
        nodes[cfg.id] = {
            ...
            dt: 20,                                 // Discrete time step in ms
            state: state,               
            vstate: vstate,
            vartheta: 0,
            eta: 1,                                 // scale = 1e6 --> eta = 1 corresponds to 1e-6 in float
            alpha: 10000,                           // scale = 1e6 --> alpha = 10000 corresponds to 0.01 in float
            delta: 10000,                           // scale = 1e6 --> delta = 10000 corresponds to 0.01 in float
            consensual_avg_law: false,              // use conventional asymptotic consensual average law
            disturbance: {                    
                disturbance_on: true,        
                amplitude: 1000000,          // scale = 1e6 --> amplitude = 1000000 corresponds to 1.0 in float
                offset: 0,                   // scale = 1e6 --> offset = 0 corresponds to 0.0 in float
                beta: 100000,                // scale = 1e6 --> beta = 100000 corresponds to 0.1 in float
                Amp: 400000,                 // scale = 1e6 --> Amp = 400000 corresponds to 0.4 in float
                frequency: 1,  
...
// ... <---> 1 <---> 2 <---> 3 <---> ... 28 <---> 29 <---> 30 <---> ...
TOPOLOGY = [
{id: 1,  ip: '192.168.0.136', type: TYPE_BLE,    enabled:  true, neighbors: [29, 30,  2,  3], clock: 200}, 
{id: 2,  ip: '192.168.0.101', type: TYPE_BLE,    enabled:  true, neighbors: [30,  1,  3,  4], clock: 200}, 
{id: 3,  ip: '192.168.0.134', type: TYPE_BLE,    enabled:  true, neighbors: [ 1,  2,  4,  5], clock: 200}, 
{id: 4,  ip: '192.168.0.191', type: TYPE_BLE,    enabled:  true, neighbors: [ 2,  3,  5,  6], clock: 200}, 
{id: 5,  ip: '192.168.0.166', type: TYPE_BLE,    enabled:  true, neighbors: [ 3,  4,  6,  7], clock: 200}, 
{id: 6,  ip: '192.168.0.130', type: TYPE_BLE,    enabled:  true, neighbors: [ 4,  5,  7,  8], clock: 200}, 
{id: 7,  ip: '192.168.0.126', type: TYPE_BLE,    enabled:  true, neighbors: [ 5,  6,  8,  9], clock: 200}, 
{id: 8,  ip: '192.168.0.122', type: TYPE_BLE,    enabled:  true, neighbors: [ 6,  7,  9, 10], clock: 200}, 
{id: 9,  ip: '192.168.0.146', type: TYPE_BLE,    enabled:  true, neighbors: [ 7,  8, 10, 21], clock: 200}, 
{id: 10, ip: '192.168.0.135', type: TYPE_BLE,    enabled:  true, neighbors: [ 8,  9, 21, 22], clock: 200}, 
{id: 11, ip: '192.168.0.136', type: TYPE_WIFI,   enabled:  true, neighbors: [24, 25, 12, 13], clock: 200},  
{id: 12, ip: '192.168.0.101', type: TYPE_WIFI,   enabled:  true, neighbors: [25, 11, 13, 14], clock: 200}, 
{id: 13, ip: '192.168.0.134', type: TYPE_WIFI,   enabled:  true, neighbors: [11, 12, 14, 15], clock: 200}, 
{id: 14, ip: '192.168.0.191', type: TYPE_WIFI,   enabled:  true, neighbors: [12, 13, 15, 16], clock: 200}, 
{id: 15, ip: '192.168.0.166', type: TYPE_WIFI,   enabled:  true, neighbors: [13, 14, 16, 17], clock: 200}, 
{id: 16, ip: '192.168.0.130', type: TYPE_WIFI,   enabled:  true, neighbors: [14, 15, 17, 18], clock: 200}, 
{id: 17, ip: '192.168.0.126', type: TYPE_WIFI,   enabled:  true, neighbors: [15, 16, 18, 19], clock: 200}, 
{id: 18, ip: '192.168.0.122', type: TYPE_WIFI,   enabled:  true, neighbors: [16, 17, 19, 20], clock: 200}, 
{id: 19, ip: '192.168.0.146', type: TYPE_WIFI,   enabled:  true, neighbors: [17, 18, 20, 26], clock: 200}, 
{id: 20, ip: '192.168.0.135', type: TYPE_WIFI,   enabled:  true, neighbors: [18, 19, 26, 27], clock: 200}, 
{id: 21, ip: '192.168.0.136', type: TYPE_BRIDGE, enabled:  true, neighbors: [ 9, 10, 22, 23], clock: 200}, 
{id: 22, ip: '192.168.0.101', type: TYPE_BRIDGE, enabled:  true, neighbors: [10, 21, 23, 24], clock: 200}, 
{id: 23, ip: '192.168.0.134', type: TYPE_BRIDGE, enabled:  true, neighbors: [21, 22, 24, 25], clock: 200}, 
{id: 24, ip: '192.168.0.191', type: TYPE_BRIDGE, enabled:  true, neighbors: [22, 23, 25, 11], clock: 200}, 
{id: 25, ip: '192.168.0.166', type: TYPE_BRIDGE, enabled:  true, neighbors: [23, 24, 11, 12], clock: 200}, 
{id: 26, ip: '192.168.0.130', type: TYPE_BRIDGE, enabled:  true, neighbors: [19, 20, 27, 28], clock: 200}, 
{id: 27, ip: '192.168.0.126', type: TYPE_BRIDGE, enabled:  true, neighbors: [20, 26, 28, 29], clock: 200}, 
{id: 28, ip: '192.168.0.122', type: TYPE_BRIDGE, enabled:  true, neighbors: [26, 27, 29, 30], clock: 200}, 
{id: 29, ip: '192.168.0.146', type: TYPE_BRIDGE, enabled:  true, neighbors: [27, 28, 30,  1], clock: 200}, 
{id: 30, ip: '192.168.0.135', type: TYPE_BRIDGE, enabled:  true, neighbors: [28, 29,  1,  2], clock: 200}, 
];
